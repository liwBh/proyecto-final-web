USE [master]
GO
/****** Object:  Database [bdbebidas]    Script Date: 25/06/2023 10:06:19 a. m. ******/
...
USE [bdbebidas]
GO
/****** Object:  Table [dbo].[tbbebida]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[tbfavorito]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbsesion]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbusuario]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[tbbebida] ([bebidaid], [bebidanombre], [bebidapreparacion], [bebidaimgruta], [bebidatipoalcohol], [bebidavaso], [bebidacategoria], [bebidaingredientes], [bebidamedidas], [bebidausuarioid]) VALUES (1, N'sample string 2', N'sample string 3', N'sample string 1-sample string 2', N'sample string 6', N'sample string 7', N'sample string 5', N'sample 34-sample 42', N'sample string 1-sample string 2', 8)
GO
SET IDENTITY_INSERT [dbo].[tbbebida] OFF
GO
SET IDENTITY_INSERT [dbo].[tbfavorito] ON 
GO
INSERT [dbo].[tbfavorito] ([favoritoid], [favoritousuarioid], [favoritobebidaid]) VALUES (2, 2, 1)
GO
SET IDENTITY_INSERT [dbo].[tbfavorito] OFF
GO
SET IDENTITY_INSERT [dbo].[tbusuario] ON 
GO
INSERT [dbo].[tbusuario] ([usuarioid], [usuarionombre], [usuarioapellidos], [usuariocorreo], [usuariopassword], [usuariofecharegistro], [usuarionumeroverificacion], [usuarioestado]) VALUES (1, N'sample string 2', N'sample string 3', N'sample string 4', N'ZAem/0ez2pB6rNyrJ8eTbQ', CAST(N'2023-06-25T03:07:27.420' AS DateTime), N'WgI12jJfw6fReZtW4LHWNA', 0)
GO
INSERT [dbo].[tbusuario] ([usuarioid], [usuarionombre], [usuarioapellidos], [usuariocorreo], [usuariopassword], [usuariofecharegistro], [usuarionumeroverificacion], [usuarioestado]) VALUES (2, N'sample string 2', N'sample string 3', N'sample@gmail.com', N'ZAem/0ez2pB6rNyrJ8eTbQ', CAST(N'2023-06-25T03:07:45.363' AS DateTime), N'8ETHb2r9vtAUSX2jVD7amQ', 0)
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_ABRIR_SESION]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_ACTIVAR_USUARIO]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_ACTUALIZAR_BEBIDA]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_ACTUALIZAR_USUARIO]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_AGREGAR_FAVORITO]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_CERRAR_SESION]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_ELIMINAR_BEBIDA]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_ELIMINAR_FAVORITO]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_ELIMINAR_USUARIO]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_INGRESAR_USUARIO]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_INSERTAR_BEBIDA]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_Login]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[SP_OBTENER_BEBIDAS]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_OBTENER_FAVORITOS_USUARIOS]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_OBTENER_TODAS_BEBIDAS]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_VERIFICAR_FAVORITO]    Script Date: 25/06/2023 10:06:20 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
